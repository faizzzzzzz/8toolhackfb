...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MR.F  [ACP]"$i"          |"
echo $i" |"$pu"PENYEMANGAT :"$ku"MANTAN GUE YANG NYAKITIN"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [ALLAH SWT] [NABI MUHAMMAD SAW] [GURU GUE]"$i"  |"
echo $i" |"$cy"            ~ [*A*C*P*] [ALL MEMBER ACP] [BANG ADITYA]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 085220205961"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" XXXXXXXXXXX@GMAIL.COM"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
